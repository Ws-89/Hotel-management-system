...
public class RegistrationService {
    ...
    public RegistrationService(GuestService guestService, EmailValidator emailValidator, EmailSender emailSender, ConfirmationTokenService confirmationTokenService) {
    ...
    public void register(RegistrationRequest request){
        ...
        String token = guestService.signUpGuest(
                new Guest(
    ...
    public String confirmToken(String token) {
        ...
        Long userId = confirmationTokenService.getUserId(token);
        guestService.enableAppUser(userId);
        return "confirmed";
    }
